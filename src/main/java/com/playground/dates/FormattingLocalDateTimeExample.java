...
public class FormattingLocalDateTimeExample {
  ...
  public static void parseLocalDateTime() {
    ...
    System.out
        .println("custom date time format: " + LocalDateTime.parse(dateTime1, dateTimeFormatter));
    ...
    System.out
        .println("custom date time format: " + LocalDateTime.parse(dateTime2, dateTimeFormatter1));
  }
