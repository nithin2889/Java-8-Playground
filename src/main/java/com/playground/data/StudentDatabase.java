...
public class StudentDatabase {
  ...
  public static List<Student> getAllStudents() {
    ...
    Student student1 =
        new Student(
            "Adam", 2, 3.6, "male", 11, Arrays.asList("swimming", "basketball", "volleyball"));
    Student student2 =
        new Student(
            "Jenny", 2, 3.8, "female", 12, Arrays.asList("swimming", "gymnastics", "soccer"));
    /** 3rd grade students */
    Student student3 =
        new Student(
            "Emily", 3, 4.0, "female", 10, Arrays.asList("swimming", "gymnastics", "aerobics"));
    Student student4 =
        new Student("Dave", 3, 4.0, "male", 9, Arrays.asList("swimming", "gymnastics", "soccer"));
    /** 4th grade students */
    Student student5 =
        new Student(
            "Sophia", 4, 3.5, "female", 15, Arrays.asList("swimming", "dancing", "football"));
    Student student6 =
        new Student(
            "James",
            4,
